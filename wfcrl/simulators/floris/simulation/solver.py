...
from wfcrl.simulators.floris.simulation.turbine import average_velocity
from wfcrl.simulators.floris.simulation.turbine_multi_dim import (
    axial_induction_multidim,
    Ct_multidim,
    multidim_Ct_down_select,
)
from wfcrl.simulators.floris.simulation.wake import WakeModelManager
from wfcrl.simulators.floris.simulation.wake_deflection.empirical_gauss import yaw_added_wake_mixing
from wfcrl.simulators.floris.simulation.wake_deflection.gauss import (
    calculate_transverse_velocity,
    wake_added_yaw,
    yaw_added_turbulence_mixing,
)
from wfcrl.simulators.floris.type_dec import NDArrayFloat
from wfcrl.simulators.floris.utilities import cosd
...
def sequential_solver(
    ...
    for i in range(grid.n_turbines):
        ...
        axial_induction_i = axial_induction(Ct=ct_i,
            velocities=flow_field.u_sorted,
            yaw_angle=farm.yaw_angles_sorted,
            tilt_angle=farm.tilt_angles_sorted,
            ref_tilt_cp_ct=farm.ref_tilt_cp_cts_sorted,
        ...
        farm.pitch_angles_sorted[:, :, i:i+1, None, None] = farm.ct_to_pitch(TSR_i, ct_i)

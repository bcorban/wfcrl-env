...
from wfcrl.simulators.floris import logging_manager
...
from wfcrl.simulators.floris.utilities import load_yaml
...
class Floris(BaseClass):
    ...
    def __attrs_post_init__(self) -> None:
        ...
        self.farm.construct_turbine_cts(self.flow_field.n_wind_directions, self.flow_field.n_wind_speeds)
        ...
        self.farm.set_pitch_angles(self.flow_field.n_wind_directions, self.flow_field.n_wind_speeds)

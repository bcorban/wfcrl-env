...
from wfcrl.simulators.floris.logging_manager import LoggerBase
from wfcrl.simulators.floris.simulation import Floris, State
from wfcrl.simulators.floris.simulation.turbine import (
    average_velocity,
    axial_induction,
    Ct,
    power,
...
from wfcrl.simulators.floris.simulation.turbine_multi_dim import multidim_power_down_select, power_multidim
from wfcrl.simulators.floris.tools.cut_plane import CutPlane
...
class FlorisInterface(LoggerBase):
    ...
    def calculate_wake(
        ...
        ct_actions: NDArrayFloat | list[float] | None = None,
    ...
    def calculate_horizontal_plane(
        ...
        current_cts = self.floris.farm.cts
        ...
        if yaw_angles is not None:
            self.floris.farm.yaw_angles = yaw_angles
        self.floris.farm.cts = current_cts
        # Calculate wake
        ...
        self.calculate_wake(yaw_angles=current_yaw_angles,ct_actions=current_cts)
    ...
    def get_turbine_powers(self) -> NDArrayFloat:
        ...
        turbine_powers = power(cps = self.floris.farm.pitch_to_cps(),
